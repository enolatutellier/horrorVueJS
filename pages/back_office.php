                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Ici vous pouvez ajouter ou supprimer des catégories de personnage du site.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Ici vous pouvez ajouter ou supprimer des médias du site, concernant les personnages (films, séries, etc.).</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Ici vous pouvez ajouter ou supprimer des images liées aux personnages du site.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
