    ...
    <body>
        <div id="app">
            ...
            <section class="wrapper">
                <div class="intro">
                    <h1>Bienvenue !</h1>
                    <p>Venez découvrir ou redécouvrir les tueurs et les monstres les plus célèbres du monde de l'horreur.</p>
                </div>
        ...
        <script>
            ...
            var myListener = function () {
                ...
                // ajout d'un écouteur d'évènement afin de détecter le survol des éléments "figure" part la souris,
                // dans le but de pouvoir identifier l'id du tueur de la carte survolée et mettre à jour 
                // les liens des gifs à la volée, pour afficher les 2 gifs du tueur survolé.
